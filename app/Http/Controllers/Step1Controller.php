...
class Step1Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // dd($project['dosar_an']);
        $this->document->makeDocFromTemplate(1, $project, $penas);
        $this->document->makeDocFromTemplate(2, $project, $penas);



        return response()->json(['status' => 200, 'msg' => $msg, 'url' => '/poprire', 'file_list' => $this->document->existDoc($input['dosar_nr'], $input['dosar_an'])]);
    }
