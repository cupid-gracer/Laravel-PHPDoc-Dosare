...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
		@include('layouts.widgets.headermobile')
		<!--end::Header Mobile-->
		...
		<!--end::Main-->
		<!--begin::User-->
        @include('layouts.widgets.user')
		<!--end::User-->
		
		<input id="msg_status" type="hidden" value="{{Session::get('msg_status')}}">
		<input id="msg" type="hidden" value="{{Session::get('msg')}}">
