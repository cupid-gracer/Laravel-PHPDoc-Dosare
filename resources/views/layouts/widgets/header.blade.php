    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch mr-3">
            ...
            <div class="header-logo">
                ...
                {{-- <a href="https://dosare.bejdragan.ro/dosar_nou">Go to dosare.bejdragan.ro</a> --}}
            </div>
            <!--end::Header Logo-->
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
                    ...
                    <ul class="menu-nav">
                        ...
                        ?>
                        <li class="menu-item menu-item-rel {{$pagename == 'step1'? $select:''}}"  aria-haspopup="true">
                            <a href="/dosar_nou" class="menu-link">
                                <span class="menu-text">Dosar nou</span>
                                <i class="menu-arrow"></i>
                            </a>
                        </li>
                        <li class="menu-item menu-item-rel  {{$pagename == 'step2'? $select:''}}" data-menu-toggle="click" aria-haspopup="true">
                        ...
                        <li class="menu-item menu-item-rel {{$pagename == 'step3'? $select:''}}" data-menu-toggle="click" aria-haspopup="true">
                        ...
                        <li class="menu-item menu-item-rel {{$pagename == 'step4'? $select:''}}" data-menu-toggle="click" aria-haspopup="true">
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item">
                    <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
                        ...
                        <span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">{{Auth::user()?Auth::user()->name:''}}</span>
                        <span class="symbol symbol-35">
                            <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">{{ucfirst(substr(Auth::user()->name, 0,1))}}</span>
                        </span>
                    </div>
                    <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
                        <a href="/logout">
